...
sources:
  ...
  - source_id: "youtube-1-TZqOsVCNM"
    title: "How to Get Rich"
    creator: "Naval Ravikant"
    url: "https://youtu.be/1-TZqOsVCNM"
    evidence_type: "PHILOSOPHICAL_ARGUMENT"
    key_contributions:
      - claim: "The Core Wealth Axiom: Seek wealth, not money or status. Wealth consists of assets that earn while you sleep; money is how we transfer wealth; status is your rank in the social pecking order."
      - claim: "Specific Knowledge & Productizing Yourself: Specific knowledge is knowledge that society cannot easily train you for; if society can train you, it can train someone else and replace you. Lean into curiosity and obsession to build uncopyable judgment."
...
active_recall:
  ...
  - question: "What is the difference between Wealth, Money, and Status according to Naval Ravikant?"
    concept: "Naval's Tripartite Capital Taxonomy"
    answer: "Wealth consists of productive assets that earn while you sleep (businesses, equity, software, real estate). Money is an IOU token used to transfer time and wealth. Status is your relative social rank in a zero-sum hierarchy. High-agency individuals focus exclusively on wealth creation, ignoring status games."
  - question: "Why is 'Specific Knowledge' impossible for society to train through conventional curricula?"
    concept: "Specific Knowledge vs Commoditized Skills"
    answer: "Specific knowledge is found by pursuing your genuine curiosity and obsession rather than whatever is hot in the market. It feels like play to you but looks like hard work to others. Because it cannot be broken down into a standard manual, society cannot mass-train others to replace you, giving you extreme pricing power."
  - question: "What are 'Permissionless Leverage' and why are code and media revolutionary?"
    concept: "Permissionless vs Permissioned Leverage"
    answer: "Traditional leverage (labor and capital) requires permission: someone must agree to work for you, or an investor/bank must give you capital. Code and media are permissionless: you need no one's approval to write software or publish a broadcast that scales to billions of users at zero marginal replication cost."
