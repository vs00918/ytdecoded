...
sources:
  ...
  - source_id: "SRC-ABRAINO-ACTIVE-RECALL"
    title: "Study and Learn Using ACTIVE RECALL"
    creator: "ABrainoConscious"
    url: "https://www.youtube.com/watch?v=TeCYHJO4rKk"
    evidence_type: "PRACTITIONER_EXPERIENCE"
    key_contributions:
  ...
  - source_id: "SRC-JUSTIN-SUNG-PERRO-SYSTEM"
    title: "7 Years of Building a Learning System in 12 minutes"
    creator: "Dr. Justin Sung"
    url: "https://www.youtube.com/watch?v=6GTt10GDWII"
    evidence_type: "PRACTITIONER_EXPERIENCE"
    key_contributions:
      - claim: "The PERRO Learning Pipeline: Priming, Encoding, Reference, Retrieval, and Overlearning unifies cognitive load theory with memory consolidation into a sequential 5-stage architecture"
...
active_recall:
  ...
  - question: "What is the 'Overlearning Inversion Trap' and why does brute-force repetition fail to rescue poor exam performance?"
    concept: "The Overlearning Inversion Trap"
    answer: "Overlearning (high-volume flashcard repetition and past paper drilling) is an end-stage hardening tool to build speed, not a primary learning engine. When students skip relational priming and deep encoding, information lacks semantic relevance. Using repetition as a first strategy futilely attempts to compensate for defective encoding through sheer volume, producing brittle, narrow knowledge."
...
```mermaid
graph LR
    subgraph SG_1_PERRO_Pipeline ["The PERRO 5-Stage Cognitive Architecture"]
