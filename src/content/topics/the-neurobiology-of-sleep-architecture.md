...
summary_15s: "Sleep supports cognitive learning through pre-encoding preparation and slow-wave spindle consolidation, while acute restriction produces measurable deficits in memory, immune markers, and gene expression."
tags:
  - "Neurobiology"
  - "Sleep"
  ...
  - "Immunology"
mental_models:
  - "Dual-Stage Memory Processing"
  - "Hippocampal Intake State"
  - "Sleep Debt Asymmetry"
  - "Stimulus Control Conditioning"
relationships:
  - target_slug: "the-second-brain-and-the-gut-mind-axis"
    type: "builds_on"
    confidence: "EXPLICIT"
  - target_slug: "the-pathology-of-comfort-and-progressive-friction"
    type: "contrasts_with"
    confidence: "EXPLICIT"
  - target_slug: "the-morning-architecture-and-discipline"
    type: "applies_to"
    confidence: "EXPLICIT"
sources:
  - source_id: "5MuIMqhT8DM"
...
```mermaid
graph TD
    subgraph Cognitive["Cognitive Domain: Memory Dynamics"]
        Pre["Sleep Before Learning"] -->|Prepares Hippocampus| Encode["40% Encoding Advantage (Rested vs Deprived)"]
        Post["Sleep After Learning"] -->|Deep NREM & Spindles| Consolidate["Memory Stabilization & Integration"]
    end

    subgraph Somatic["Somatic Domain: Physiological Impact"]
        Restr4h["4-Hour Sleep (1 Night)"] --> NK["70% Drop in NK Cell Activity"]
        Restr6h["6-Hour Sleep (1 Week)"] --> Genes["711 Genes Altered (Inflammation Up, Immune Down)"]
    end

    subgraph Behavioral["Practical Application: Sleep Hygiene"]
        R1["1. Daily Regularity: Consistent Bed/Wake Times"]
        R2["2. Ambient Cooling: ~65°F / 18°C Environment"]
        R3["3. Stimulus Control: Leave Bed if Awake >20 min"]
    end
```
